...
public class UnitWriter {
	...
	public static void writeUnit(AHKCompiledHandle handle, Unit unit, TextBuffer tb, ErrorWrapper errors) {
	...
	public final AHKCompiledHandle projectHandle;
	...
	private UnitWriter(AHKCompiledHandle handle, Unit unit, TextBuffer tb) {
